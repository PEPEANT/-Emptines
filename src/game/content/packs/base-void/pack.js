...
export const BASE_VOID_PACK = {
  ...
  world: {
    ...
    clouds: {
      ...
      maxPuffs: 15,
      puffSpread: 2.6,
      puffHeightSpread: 0.24,
      mobileCountScale: 0.55,
      windAngle: -0.46,
      windVariance: 0.34,
      cirrusCount: 5,
      distantCount: 10,
      distantHeightBoost: 20,
      distantOpacityScale: 0.82,
      emissive: 0x304a63,
    ...
    hubFlow: {
      ...
      bridge: {
        approachSpawn: [0, GAME_CONSTANTS.PLAYER_HEIGHT, -124],
        spawn: [0, GAME_CONSTANTS.PLAYER_HEIGHT, -86],
        npcPosition: [0, 0, -112],
        npcScale: 1.34,
        npcTriggerRadius: 8.2,
